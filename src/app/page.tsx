    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between selection:bg-blue-500 selection:text-white relative overflow-x-hidden font-sans">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/75 border-b border-slate-800/80 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/dashboard"
              className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold rounded-xl shadow-md shadow-blue-500/20 transition-all flex items-center gap-1.5 group"
            >
      ...
      <section className="relative pt-20 pb-16 px-6 max-w-7xl mx-auto w-full text-center space-y-8 z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          ...
          >
            <span>Explore Class Results Master Table</span>
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </Link>

          <Link
            href="/login"
            className="px-6 py-3.5 bg-slate-900/90 hover:bg-slate-800 border border-slate-700/80 text-slate-200 text-sm font-bold rounded-xl transition-all flex items-center gap-2"
          >
      ...
      <section className="py-12 px-6 max-w-5xl mx-auto w-full z-10">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-blue-900/60 via-indigo-900/50 to-purple-900/60 border border-blue-500/30 backdrop-blur-xl text-center space-y-6 shadow-2xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link
              href="/dashboard"
              className="px-6 py-3 bg-white text-slate-950 font-extrabold text-xs rounded-xl shadow-lg hover:bg-slate-100 transition-colors flex items-center gap-2"
            >
            ...
            <Link
              href="/login"
              className="px-6 py-3 bg-blue-600/30 hover:bg-blue-600/40 border border-blue-400/40 text-white font-bold text-xs rounded-xl transition-colors"
            >
