    ...
    <Shell noScroll>
      <div className="h-full max-h-screen overflow-hidden p-4 lg:p-5 pb-8 flex flex-col justify-start gap-3.5 w-full bg-slate-50 select-none">
        ...
        <div className="grid grid-cols-12 gap-3.5 h-[345px] flex-shrink-0">
          ...
          <div className="col-span-7 bg-white rounded-xl border border-slate-200 p-3.5 shadow-xs flex flex-col justify-between h-full min-h-0">
            <div className="flex items-center justify-between pb-1.5 border-b border-slate-100 flex-shrink-0">
              <div className="flex items-center gap-2">
                <span className="w-6 h-6 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center border border-blue-100">
          ...
          <div className="col-span-5 bg-white rounded-xl border border-slate-200 p-3.5 shadow-xs flex flex-col justify-between h-full min-h-0">
            <div className="flex items-center justify-between pb-1.5 border-b border-slate-100 flex-shrink-0">
              <div className="flex items-center gap-2">
                <span className="w-6 h-6 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center border border-blue-100">
              ...
              <Link href="/dashboard/checking-lists" className="text-xs text-blue-600 font-bold hover:underline">
                Checking List &rarr;
              </Link>
            </div>

            <div className="flex-1 flex items-center gap-4 py-1 min-h-0">
              ...
              <div className="relative w-48 h-48 flex-shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  ...
                  <span className="text-[10px] text-slate-500 font-semibold mt-0.5">Pass Rate</span>
                </div>
              </div>
