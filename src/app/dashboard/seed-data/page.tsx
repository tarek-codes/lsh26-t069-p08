...
export default function SeedDataPage() {
  ...
  const edgeCases = [
    ...
    },
    {
      ...
      profile: "Optional AGR score 40 (GP 2.00).",
      rawGPA: "5.00",
      finalGPA: "5.00 (A+)",
      passed: true,
    ...
    },
    {
      ...
      explanation:
        "Optional GP 5.00 contributes (5.00 - 2.00) = +3.00 bonus points, adding +0.50 to student's overall GPA without changing the 6.0 divisor.",
    },
    {
      id: "S006",
      edgeId: "EDGE-06",
    ...
    },
    {
      ...
      explanation:
        "Absent mark in optional subject contributes 0.00 bonus points. Student passes on the strength of their 6 compulsory subjects.",
    },
  ];
